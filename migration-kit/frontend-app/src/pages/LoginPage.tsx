...
export function LoginPage() {
  ...
  useEffect(() => {
    if (isAuthenticated && user && isKnownUserRole(user.userType)) {
      navigate(getDefaultRouteForRole(user.userType), { replace: true });
    }
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (authenticatedUser && isKnownUserRole(authenticatedUser.userType)) {
      navigate(getDefaultRouteForRole(authenticatedUser.userType));
    }
  }
